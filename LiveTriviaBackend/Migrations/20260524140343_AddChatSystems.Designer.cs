...
namespace LiveTriviaBackend.Migrations
{
    ...
    [Migration("20260524140343_AddChatSystems")]
    partial class AddChatSystems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("live_trivia.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("live_trivia.MessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ChatMessageId", "PlayerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("live_trivia.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QuizQuestion", b =>
                {
                    ...
                    b.HasOne("live_trivia.Quiz", null)
                        .WithMany()
            ...
            modelBuilder.Entity("live_trivia.ChatMessage", b =>
                {
                    ...
                    b.HasOne("live_trivia.Player", "SenderPlayer")
                        .WithMany()
            ...
            modelBuilder.Entity("live_trivia.MessageReaction", b =>
                {
                    b.HasOne("live_trivia.ChatMessage", "ChatMessage")
                        .WithMany("Reactions")
